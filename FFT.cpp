/*--------------------------------------------------------------------------
 * This is a slightly modified version of the Cooley-Tukey FFT found on the
 * Wikipedia page here: 
 * https://en.wikipedia.org/wiki/Cooley%E2%80%93Tukey_FFT_algorithm#C++_Example_Code
 *
 * The added changes are in the form of a change in console output formatted for easier graphing. 
 * Otherwise, this code remains unchanged.
 * The purpose of using this code was for me to better understand how the Cooley-Tukey
 * Radix-2 algorithm worked. 
 *
 * Modified by Aidan Sommerfeld
 */
...
int main() {
  ...
  //----------------------------------------------------------------------------
	...
	for (int i = 0; i < nSamples; i++){
		printf("(%.3f,%.3f)", i*freqResolution, abs(X[i]));
	}
  //----------------------------------------------------------------------------
}
